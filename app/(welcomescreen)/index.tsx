...
import { stream } from "@/components/imageLink";
        ...
        <SafeAreaView style={styles.container}>
          ...
          <LinearGradient style={styles.gradient} colors={["#080714","#0D0945","#ffffff"]} start={[0.5,0.2]} locations={[0.1,0.35,0.35]}>
             ...
             <View style={styles.imageStyle} >
               <ImageViewer imageSource={stream}/>
             </View>
             ...
             <View style={{  gap:20, margin:5,alignItems:"center"}}>
                <Text style={{
                    ...
                    Stream and Download All Songs
                </Text >
              
             </View>
             <View style={{ paddingHorizontal:100, marginTop:5}}>
             <Text style={{
                         fontSize: 16,
                         textAlign:'center',  
                    ...
                    Stream new Songs and also Download
                 </Text>
             </View>
             ...
             <View style={{display:'flex',flexDirection:"column",marginTop:110, gap:10,alignItems:"center"}}>
               <View style={{display:'flex',flexDirection:"row", gap:5,alignItems:"center"}}>
                  ...
                  <Link href="/start1" style={styles.button}>
