...
import { friend } from "@/components/imageLink";

export default function Start(){

    
    const pathname = usePathname();
    const {starting,stop} = useSession ();
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={{alignItems:"flex-end" }}>
             ...
             <View style={styles.imageStyle} >
               <ImageViewer imageSource={friend}/>
             </View>
             ...
             <Text style={{
                   ...
                   Be able to share Songs with friends and 
                   family
                 </Text>
             </View>
             ...
             <View style={{display:'flex',flexDirection:"column",marginTop:110, gap:10,alignItems:"center"}}>
               <View style={{display:'flex',flexDirection:"row", gap:5,alignItems:"center"}}>
                  ...
                  <Link href='/start3' style={styles.button}>
